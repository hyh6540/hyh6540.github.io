...
## Journal
- **Y. He**, X. Li, and J. Luo, "Task-Oriented Integrated Sensing and Semantic Communications for Multi-Device Video Analytics," accepted by IEEE Trans. Mobile Comput., 2025. 
- Z. Ye, Q. Xiao, J. Liu, **Y. He (corresponding author)**, G. Yu, and J. Han, "Practical WiFi Indoor Localization: Unleashing the Potential of GNNs for Accuracy and Robustness," accepted by IEEE Trans. Mobile Comput., 2025. [[PDF]](pdf/TMC25_GraphFi.pdf)
...
- **Y. He**, J. Liu, M. Li, G. Yu, and J. Han, "Forward-compatible integrated sensing and communication for WiFi," IEEE J. Sel. Areas Commun., vol. 42, no. 9, pp. 2440--2456, Sep. 2024. [[PDF]](pdf/JSAC24_ISAC_WiFi.pdf) 
...
## Conference
- X. Li, **Y. He (corresponding author)**, and J. Luo, "𝜇Ceiver-Fi: Exploiting Spectrum Resources of Multi-Link Receiver for Fine-Granularity Wi-Fi Sensing", in Proc. ACM MobiCom, Nov. 2025, pp. 1045--1059. (CCF-A, acceptance rate in the winter session: 36/348=10.3%) [[PDF]](https://dl.acm.org/doi/pdf/10.1145/3680207.3765263)
